...
part::create itcl \
    -buildcommand {
        conf::norelnoacmainconfigure [part::srcdir itcl]/itcl --disable-shared [conf::c_with tcl] [conf::c_disen thread threads] [conf::c_disen debug symbols]
    ...
    -librarycommand {
        ...
        set rc [list]
        lappend rc [part::destdir itcl]/[conf::x lib]itcl[part::dotversion $ver][conf::c_if debug [conf::gsuffix] ""].a
        return $rc
    } \
    -depend {tcl} \
...
part::create itk \
    -buildcommand {
        conf::norelnoacmainconfigure [part::srcdir itcl]/itk --disable-shared [conf::c_with tcl] [conf::c_with tk] [conf::c_disen thread threads] [conf::c_disen debug symbols]
        if {$::tcl_platform(platform)=="windows"} {
	    out::printcommand "Converting Makefile"
