...
scalar sasfit_peak_PearsonVIIAmplitude(scalar x, sasfit_param * param)
{
	scalar z;
	scalar bckgr, a0, center, width, shape;

	SASFIT_ASSERT_PTR( param );

	sasfit_get_param(param, 5, &a0, &center, &width, &shape, &bckgr);
