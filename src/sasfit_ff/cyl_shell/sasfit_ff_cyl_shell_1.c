/*
 * src/sasfit_ff/cyl_shell/sasfit_ff_cyl_shell_1.c
 *
...
{
	CYL_SHELL_INT_BODY(sasfit_ff_cyl_shell_1_core, 2.0);
}

scalar sasfit_ff_cyl_shell_1_f(scalar q, sasfit_param * param)
{
	CYL_SHELL_INT_BODY(sasfit_ff_cyl_shell_1_core, 1.0);
}
