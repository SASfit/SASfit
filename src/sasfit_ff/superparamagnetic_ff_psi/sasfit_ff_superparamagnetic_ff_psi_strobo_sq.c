/*
 * src/sasfit_ff/superparamagnetic_ff_psi/sasfit_ff_superparamagnetic_ff_psi_strobo_sq.c
 *
...
#define SET_SQ			SET_SQ_IDENT
#define TRIANGULAR_PARAM        TRIANGULAR_PARAM_DEFAULT
scalar sasfit_ff_superparamagnetic_ff_psi_strobo_sq(scalar t, sasfit_param * param)
{
