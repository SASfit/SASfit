/*
 * src/sasfit_ff/superparamagnetic_ff_psi/sasfit_ff_superparamagnetic_ff_psi_strobo_sq_l2x_pol.c
 *
...
scalar sasfit_ff_superparamagnetic_ff_psi_strobo_sq_l2x_pol(scalar t, sasfit_param * param)
{
