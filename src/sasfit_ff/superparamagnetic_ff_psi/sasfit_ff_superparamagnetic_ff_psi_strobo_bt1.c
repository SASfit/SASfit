/*
 * src/sasfit_ff/superparamagnetic_ff_psi/sasfit_ff_superparamagnetic_ff_psi_strobo_bt1.c
 *
...
#define SET_SQ			SET_SQ_B1
#define TRIANGULAR_PARAM        TRIANGULAR_PARAM_DEFAULT
scalar sasfit_ff_superparamagnetic_ff_psi_strobo_bt1(scalar t, sasfit_param * param)
{
