/*
 * src/sasfit_ff/superparamagnetic_ff_psi/sasfit_ff_superparamagnetic_ff_psi_strobo.c
 *
...
#define SET_BT			SET_BT_PLAIN
#define SET_ALPHA 		SET_ALPHA_DEFAULT
#define SET_SQ			SET_SQ_ONE
#define TRIANGULAR_PARAM        TRIANGULAR_PARAM_DEFAULT
scalar sasfit_ff_superparamagnetic_ff_psi_strobo(scalar t, sasfit_param * param)
{
	HEADER_FF_PSI_STROBO;

	// get supplied parameters (probably from GUI)
	sasfit_get_param(param, 10, &V[PHI0DEG], &V[KNUC_KMAG], &V[R], &V[R_AV], &V[MU_KT], &V[FREQ], &V[B0], &V[LAMBDA], &V[SD], &V[PSI]);
