/*
 * src/sasfit_ff/superparamagnetic_ff_psi/sasfit_ff_superparamagnetic_ff_psi_strobo_sq_l2x.c
 *
...
scalar sasfit_ff_superparamagnetic_ff_psi_strobo_sq_l2x(scalar t, sasfit_param * param)
{
	HEADER_FF_PSI_STROBO;

	// get supplied parameters (probably from GUI)
	sasfit_get_param(param, 10, &V[PHI0DEG], &V[KNUC_KMAG], &V[SQ], &V[B1], &V[MU_KT], &V[FREQ], &V[B0], &V[LAMBDA], &V[SD], &V[PSI]);
