...
\paragraph{Degeneracies are refused, not fitted.} The intensity depends on
the scale times the squared contrast, so the scale and both scattering length
densities cannot be determined together; the interface declines that
combination rather than letting the optimiser wander along a flat valley and
report a converged fit whose parameters are meaningless. The scattering
length densities are unbounded, so that an opposite sign between core and
shell is an outcome of the fit rather than an imposition.
