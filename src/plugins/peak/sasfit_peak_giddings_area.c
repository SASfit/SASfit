...
scalar sasfit_peak_giddings_area(scalar x, sasfit_param * param)
{
...
scalar sasfit_peak_giddings_area_f(scalar q, sasfit_param * param)
{
...
scalar sasfit_peak_giddings_area_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
