...
scalar sasfit_peak_pulse_with_2nd_width_amplitude(scalar x, sasfit_param * param)
{
	scalar z1, z2,u;
...
scalar sasfit_peak_pulse_with_2nd_width_amplitude_f(scalar q, sasfit_param * param)
{
...
scalar sasfit_peak_pulse_with_2nd_width_amplitude_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
