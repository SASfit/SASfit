...
scalar sasfit_peak_lognormal4parameter_area(scalar x, sasfit_param * param)
{
	scalar y;
...
scalar sasfit_peak_lognormal4parameter_area_f(scalar q, sasfit_param * param)
{
...
scalar sasfit_peak_lognormal4parameter_area_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
