...
scalar sasfit_peak_gaussian_lorentzian_sum_amplitude(scalar x, sasfit_param * param)
{
	scalar z;
	scalar u,v;
...
scalar sasfit_peak_gaussian_lorentzian_sum_amplitude_f(scalar q, sasfit_param * param)
{
...
scalar sasfit_peak_gaussian_lorentzian_sum_amplitude_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
