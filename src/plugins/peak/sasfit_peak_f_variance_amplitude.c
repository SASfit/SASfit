...
scalar sasfit_peak_f_variance_amplitude(scalar x, sasfit_param * param)
{
	scalar z,t,u,v,w;
...
scalar sasfit_peak_f_variance_amplitude_f(scalar q, sasfit_param * param)
{
...
scalar sasfit_peak_f_variance_amplitude_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
