...
scalar sasfit_peak_pulse_with_power_term_amplitude(scalar x, sasfit_param * param)
{
	scalar z;
...
scalar sasfit_peak_pulse_with_power_term_amplitude_f(scalar q, sasfit_param * param)
{
...
scalar sasfit_peak_pulse_with_power_term_amplitude_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
