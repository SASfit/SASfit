/*
 * src/plugins/triax_ellip_shell/sasfit_ff_triax_ellip_shell_sq_baba_ahmed_1.c
 *
...
scalar sasfit_ff_triax_ellip_shell_sq_baba_ahmed_1_core(scalar y, sasfit_param * param)
{
...
scalar sasfit_ff_triax_ellip_shell_sq_baba_ahmed_1_core_x(scalar x, sasfit_param * param)
{
	scalar res;
	...
	res = sasfit_integrate(0.0, 1.0, sasfit_ff_triax_ellip_shell_sq_baba_ahmed_1_core, param);

	return res;
}

scalar sasfit_ff_triax_ellip_shell_sq_baba_ahmed_1(scalar q, sasfit_param * param)
{
...
//	SASFIT_CHECK_COND1((ETA_SOL < 0.0), param, "eta_sol(%lg) < 0",ETA_SOL); // modify condition to your needs
	...
	res = sasfit_integrate(0.0, 1.0, sasfit_ff_triax_ellip_shell_sq_baba_ahmed_1_core_x, param);
	
	sasfit_init_param(&subParam);
	subParam.p[0] = c * ALPHA; // R_ref
	subParam.p[1] = ALPHA;
	subParam.p[2] = Z_P;
	subParam.p[3] = EPSILON_R;
	subParam.p[4] = MB;
	subParam.p[5] = ZB;
	subParam.p[6] = PHI * gsl_pow_3(subParam.p[0]) / (A*b*c); // vol frac
	subParam.p[7] = TEMP;

	return n*res*sasfit_sq_baba_ahmed_syl(q, &subParam);
}

scalar sasfit_ff_triax_ellip_shell_sq_baba_ahmed_1_f(scalar q, sasfit_param * param)
{
	// insert your code here
	return 0.0;
}

scalar sasfit_ff_triax_ellip_shell_sq_baba_ahmed_1_v(scalar q, sasfit_param * param, int dist)
{
	scalar b, c;
