...
scalar sasfit_ff_parallelepiped_abc3_Pnu(scalar x, sasfit_param * param) {
	scalar LNdistr;
...
scalar sasfit_ff_parallelepiped_abc3(scalar q, sasfit_param * param)
{
    ...
    return gsl_pow_2(ETA)*sasfit_integrate(cubxmin[2], cubxmax[2], &sasfit_ff_parallelepiped_abc3_Pnu, param);
}
