...
scalar sasfit_ff_parallelepiped_abc1_Pnu(scalar x, sasfit_param * param) {
	scalar LNdistr;
...
scalar sasfit_ff_parallelepiped_abc1(scalar q, sasfit_param * param)
{
	scalar sum;
    ...
    return sasfit_integrate(cubxmin[2], cubxmax[2], &sasfit_ff_parallelepiped_abc1_Pnu, param);
}

scalar sasfit_ff_parallelepiped_abc1_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_parallelepiped_abc1_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
