...
scalar sasfit_ff_def_rnd_oriented_gGc(scalar q, sasfit_param * param)
{
...
scalar sasfit_ff_def_rnd_oriented_gGc_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_def_rnd_oriented_gGc_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
