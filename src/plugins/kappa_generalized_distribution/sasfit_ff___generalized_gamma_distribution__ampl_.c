...
scalar sasfit_ff___generalized_gamma_distribution__ampl_(scalar x, sasfit_param * param)
{
	...
	z = (x-XI)/SIGMA;
	if (x<=XI) return 0.0;
	return A*sasfit_ff___generalized_gamma_distribution__area_(x,param)/sasfit_ff___generalized_gamma_distribution__area_(mode_kappa(param),param);
}

scalar sasfit_ff___generalized_gamma_distribution__ampl__f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff___generalized_gamma_distribution__ampl__v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
