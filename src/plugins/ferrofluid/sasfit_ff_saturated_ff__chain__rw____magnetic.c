...
scalar sasfit_ff_saturated_ff__chain__rw____magnetic(scalar q, sasfit_param * param)
{
...
scalar sasfit_ff_saturated_ff__chain__rw____magnetic_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_saturated_ff__chain__rw____magnetic_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
