...
scalar sasfit_ff_ff_chain_parabolic_psi(scalar q, sasfit_param * param)
{
	scalar nn;
...
scalar sasfit_ff_ff_chain_parabolic_psi_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_ff_chain_parabolic_psi_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
