...
scalar sasfit_ff_saturated_ff_chain_rw_cross_term(scalar q, sasfit_param * param)
{
...
scalar sasfit_ff_saturated_ff_chain_rw_cross_term_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_saturated_ff_chain_rw_cross_term_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
