...
scalar sasfit_ff_ff_chain_rw_radial(scalar q, sasfit_param * param)
{
...
scalar sasfit_ff_ff_chain_rw_radial_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_ff_chain_rw_radial_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
