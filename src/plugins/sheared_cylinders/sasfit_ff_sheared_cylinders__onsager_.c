...
#define DDELTA	param->p[8]


scalar sasfit_ff_sheared_cylinders__onsager_(scalar q, sasfit_param * param)
{
...
scalar sasfit_ff_sheared_cylinders__onsager__f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_sheared_cylinders__onsager__v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
