...
scalar sasfit_ff_tisane(scalar t, sasfit_param * param)
{
...
scalar sasfit_ff_tisane_f(scalar t, sasfit_param * param)
{
	// insert your code here
	return 0.0;
}

scalar sasfit_ff_tisane_v(scalar t, sasfit_param * param, int dist)
{
	// insert your code here
	return 0.0;
}
