...
scalar vesicle_pegulated_kernel(const double* x, size_t n, void* p)
{
    sasfit_param * param;
    ...
    return vesicle_pegulated(x,n,p)*LNdistrT*LNdistrR;
}

scalar vesicle_pegulated_kernel_dQR(scalar x, sasfit_param * param)
{
    scalar v[2];
	scalar LNdistr;
	sasfit_param subParam;
...
scalar vesicle_pegulated_kernel_dQT(scalar x, sasfit_param * param)
{
    scalar v[2];
	scalar LNdistr;
	sasfit_param subParam;
...
scalar sasfit_ff_vesicle_peg_piecew_const_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_vesicle_peg_piecew_const_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
