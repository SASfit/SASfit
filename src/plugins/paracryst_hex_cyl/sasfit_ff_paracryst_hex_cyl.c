...
scalar sasfit_ff_paracryst_hex_cyl(scalar q, sasfit_param * param)
{
...
scalar sasfit_ff_paracryst_hex_cyl_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_paracryst_hex_cyl_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
