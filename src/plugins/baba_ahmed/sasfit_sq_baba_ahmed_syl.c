/*
 * src/plugins/baba_ahmed/sasfit_sq_baba_ahmed_syl.c
 *
...
#define R_REF	param->p[0]
#define ALPHA	param->p[1]
#define Z_P	param->p[2]
#define EPSILON_R	param->p[3]
#define MB	param->p[4]
#define ZB	param->p[5]
#define ETA_REF	param->p[6]
#define T	param->p[7]

scalar sasfit_sq_baba_ahmed_syl(scalar q, sasfit_param * param)
{
	scalar gamm, beta, s, n, c0, nc0, ncq, a, b, vp, lb;
	scalar kd, d_eff, im, epsilon, psi_0_eff, r_eff, eta;
	...
	SASFIT_CHECK_COND1((R_REF < 0.0), param, "r_ref(%lg) < 0",R_REF);
...
scalar sasfit_sq_baba_ahmed_syl_f(scalar q, sasfit_param * param)
{
	// insert your code here
	return 0.0;
}

scalar sasfit_sq_baba_ahmed_syl_v(scalar q, sasfit_param * param, int dist)
{
	// insert your code here
	return 0.0;
}
