...
scalar sasfit_sq_hex_aniso_gaussian(scalar x, sasfit_param * param)
{
...
scalar sasfit_sq_hex_aniso_gaussian_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_sq_hex_aniso_gaussian_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
