...
static _Thread_local RFAPluginCache g_cache_RFA1_3step;
static _Thread_local int g_cacheInitialized_RFA1_3step = 0;
...
scalar sasfit_sq_RFA1_3step(scalar q, sasfit_param * param)
{
    ...
    /* As sasfit_sq_RFA1.c: these checks don't themselves stop
     * execution (see sasfit_common.h); rfa_potential_init() inside
     * rfa_common_sq_n() is the actual safety net, including for the
     * LAMBDA1<LAMBDA2<LAMBDA3 ordering checked again there. */
    ...
    return rfa_common_sq_n(q, 3, RADIUS, lambda_steps, beps_steps, VOLFRACTION,
                            rfa1_solve_warm, &g_cache_RFA1_3step, &g_cacheInitialized_RFA1_3step,
                            "RFA1_3step");
}

scalar sasfit_sq_RFA1_3step_f(scalar q, sasfit_param * param)
{
    (void)q; (void)param;
    return 0.0; // insert your code here
}

scalar sasfit_sq_RFA1_3step_v(scalar q, sasfit_param * param, int dist)
{
    (void)q; (void)param; (void)dist;
    return 0.0; // insert your code here
}

/* Frees this thread's cached RFA1_3step solution, if any -- see the
...
{
    rfa_common_release_cache(&g_cache_RFA1_3step, &g_cacheInitialized_RFA1_3step);
}
