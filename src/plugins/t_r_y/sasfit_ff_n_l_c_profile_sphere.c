...
scalar n_l_c_profile_sphere(scalar x, sasfit_param *param) {
	scalar u,fsp,qmod,y;
	qmod = Q;
...
scalar sasfit_ff_n_l_c_profile_sphere(scalar q, sasfit_param * param)
{
	...
	// insert your code here
	return gsl_pow_2(sasfit_ff_n_l_c_profile_sphere_f(q,param));
}

scalar sasfit_ff_n_l_c_profile_sphere_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
