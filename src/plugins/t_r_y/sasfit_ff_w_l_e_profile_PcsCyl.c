...
scalar sasfit_ff_w_l_e_profile_PcsCyl(scalar x, sasfit_param * param)
{
...
scalar sasfit_ff_w_l_e_profile_PcsCyl_f(scalar x, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_w_l_e_profile_PcsCyl_v(scalar u, sasfit_param * param, int dist)
{
