...
scalar sasfit_ff_ellcylsh_sd_worm_kholodenko(scalar q, sasfit_param * param)
{
	scalar Pcs,Pprime;
...
scalar sasfit_ff_ellcylsh_sd_worm_kholodenko_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_ellcylsh_sd_worm_kholodenko_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
