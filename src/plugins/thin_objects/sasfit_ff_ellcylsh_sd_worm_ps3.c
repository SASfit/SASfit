...
scalar sasfit_ff_ellcylsh_sd_worm_ps3(scalar q, sasfit_param * param)
{
	scalar Pcs,Pprime;
...
scalar sasfit_ff_ellcylsh_sd_worm_ps3_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_ellcylsh_sd_worm_ps3_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
