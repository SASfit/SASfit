...
scalar sasfit_ff_sheared_spheroids__boltzmann_(scalar q, sasfit_param * param)
{
...
scalar sasfit_ff_sheared_spheroids__boltzmann__f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_sheared_spheroids__boltzmann__v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
