...
scalar sasfit_ff_sheared_spheroids__maier_saupe_(scalar q, sasfit_param * param)
{
...
scalar sasfit_ff_sheared_spheroids__maier_saupe__f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_sheared_spheroids__maier_saupe__v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
