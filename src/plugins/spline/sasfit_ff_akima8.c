...
scalar sasfit_ff_akima8(scalar x, sasfit_param * param)
{
...
scalar sasfit_ff_akima8_f(scalar q, sasfit_param * param)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
...
scalar sasfit_ff_akima8_v(scalar q, sasfit_param * param, int dist)
{
	SASFIT_ASSERT_PTR(param); // assert pointer param is valid
