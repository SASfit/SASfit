...
#  TCL_STUB_LIBRARY       = path to static Tcl stub library 
#                           (required to build a stub enabled TCL extension)
...
SET(TK_LIBRARIES "")
IF(TCL_FOUND)
	LIST(APPEND TCL_INCLUDE_DIRS ${TCL_INCLUDE_PATH})
	LIST(APPEND TCL_LIBRARIES ${TCL_LIBRARY})
ENDIF(TCL_FOUND)
IF(TK_FOUND)
	STRING(COMPARE EQUAL ${TCL_INCLUDE_PATH} ${TK_INCLUDE_PATH} IS_EQUAL)
	IF(NOT IS_EQUAL)
		LIST(APPEND TCL_INCLUDE_DIRS ${TK_INCLUDE_PATH})
	ENDIF(NOT IS_EQUAL)
	LIST(APPEND TCL_LIBRARIES ${TK_LIBRARY})
ENDIF(TK_FOUND)

MESSAGE(STATUS "TCL_INCLUDE_DIRS=${TCL_INCLUDE_DIRS}")
MESSAGE(STATUS "TCL_LIBRARIES=   ${TCL_LIBRARIES}")
MESSAGE(STATUS "TCL_STUB_LIBRARY=${TCL_STUB_LIBRARY}")
MESSAGE(STATUS "TK_INCLUDE_DIRS= ${TK_INCLUDE_DIRS}")
