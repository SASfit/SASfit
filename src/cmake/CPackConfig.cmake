...
set(CPACK_INSTALLED_DIRECTORIES "C:/user/sasfit_0.94.12_windows_amd64;.")
set(CPACK_PACKAGE_FILE_NAME "sasfit_0.94.12_windows_amd64")
message("## CPACK: WIN32: '${WIN32}', MYWIN32: '${MYWIN32}', MYTEST: '${MYTEST}', CPACK_SYSTEM_NAME: '${CPACK_SYSTEM_NAME}'")
message("## CPACK: WIN32: '${CPACK_WIN32}', MYWIN32: '${CPACK_MYWIN32}', MYTEST: '${CPACK_MYTEST}'")
if(NOT WIN32)
