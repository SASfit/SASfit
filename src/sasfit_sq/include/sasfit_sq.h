...
sasfit_sq_DLLEXP scalar sasfit_sq_ThinCylindricalShell(scalar x, sasfit_param * param);
sasfit_sq_DLLEXP scalar sasfit_sq_ThinDiscs(scalar x, sasfit_param * param);
sasfit_sq_DLLEXP scalar sasfit_sq_ThinCylindricalShell(scalar x, sasfit_param * param);
