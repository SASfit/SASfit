...
//    double exp(doublereal), cos(doublereal), sin(doublereal), pow_di(doublereal *, integer *);
    ...
    static doublereal xabs, yabs, daux, qrho, xaux, xsum, ysum, xabsq, xquad, yquad, qlambda;
