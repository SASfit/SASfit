...
\begin{figure}[htb]
\begin{center}
\subfigure[Selection of radial profiles of cylindrical profile with a homogeneous core and a linear shell.]{
\includegraphics[width=0.48\textwidth,height=0.35\textwidth]{../images/form_factor/anisotropic/profile_LinShellCyl.png}}
\hfill
\subfigure[Corresponding cross-section function $P_\mathrm{cs}(q)$  of the profiles shown on the left.]{
\includegraphics[width=0.48\textwidth,height=0.35\textwidth]{../images/form_factor/anisotropic/PcsLinShCyl.png}}
\end{center}
...
\begin{figure}[htb]
\begin{center}
\subfigure[Selection of radial profiles of fuzzy cylindrical profile.]{
\includegraphics[width=0.48\textwidth,height=0.35\textwidth]{../images/form_factor/anisotropic/profile_fuzzyCyl.png}}
\hfill
\subfigure[Corresponding cross-section function $P_\mathrm{cs}(q)$  of the profiles shown on the left.]{
\includegraphics[width=0.48\textwidth,height=0.35\textwidth]{../images/form_factor/anisotropic/PcsFuzzyCyl.png}}
\end{center}
...
\begin{figure}[htb]
\begin{center}
\subfigure[radial profiles with $\eta_0=\Delta\eta$ for several values of $\alpha$.
]{
\includegraphics[width=0.48\textwidth]{../images/form_factor/BoucherSphere/ProfileBoucherCyl.png}}
\hfill
\subfigure[normalized radial profiles for several values of $\alpha$ to assure $\alpha$-independent excess scattering length.
]{
\includegraphics[width=0.48\textwidth]{../images/form_factor/BoucherSphere/ProfileBoucher2Cyl.png}}
\subfigure[
Scattering curves of \texttt{Pcs:Boucher cyl} for
...
\includegraphics[width=0.48\textwidth]{../images/form_factor/BoucherSphere/PcsBoucherCyl.png}}
\hfill
\subfigure[ Scattering curves of \texttt{Pcs:Boucher2cyl} for
several $\alpha$ with a narrow LogNormal size distribution of $\sigma = 0.15$.
]{
\includegraphics[width=0.48\textwidth]{../images/form_factor/BoucherSphere/PcsBoucher2Cyl.png}}
\end{center}
