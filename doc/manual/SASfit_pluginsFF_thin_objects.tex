...
\begin{align}\label{eq:Pcs:cyl_fuzzy}
  P_\mathrm{cs}(q) &= \left[2\pi \Delta\eta R^2\frac{J_1(qR)}{qR} \exp\left(-\frac12 q^2\sigma^2\right)\right]^2
\end{align}
...
\begin{align}
\eta_\text{circular}\left(r\right) &= \int_0^\infty \Delta\eta R^2\frac{J_1(qR)}{qR} \exp\left(-\frac12 q^2\sigma^2\right) J_0(qr) q \, \mathrm{d}q
\end{align}
