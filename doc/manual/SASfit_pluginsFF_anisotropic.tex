...
\label{sec:reccuboid}
In a rectangular parallelepiped, all angles are right angles, and opposite faces of a parallelepiped are equal. The terms rectangular cuboid and orthogonal parallelepiped are also used to designate this polyhedron. Four variants of rectangular parallelepipeds have been implemented, where either none, one, two, or all three axes have a common size distribution.
\begin{figure}[htb]
\begin{center}
