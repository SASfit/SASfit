...
\noindent \uline{Input Parameters for models  \texttt{profile BottleBrush (emp.)} and \texttt{BottleBrush (emp.)}:}\\
\begin{description}
...
\noindent \uline{Input Parameters for models \texttt{BottleBrush (sim)} and \texttt{profile BottleBrush (sim)}:}\\
\begin{description}
