...
\begin{figure}[htb]
\subfigure[Comparison of semi-flexible polymers without excluded volume effects]{\includegraphics[width=0.48\textwidth]{../images/form_factor/polymer_semiflexible/WormsComparison.png}}
\hfill
\subfigure[Kratky plot of the same data than on the left.]{\includegraphics[width=0.48\textwidth]{../images/form_factor/polymer_semiflexible/WormsComparisonKratky.png}} \\
