...
\subfigure[Ration between supplied error bar and the error bar guessed by \SASfit]{\label{fig:ErrorGUI}\includegraphics[width=0.47\textwidth]{../images/ErrorBar/RatioErrSuppGuess.png}}
\end{center}
\begin{center}
\subfigure[simulated model data set with supplied error bars]{\label{fig:ModelDataWithError2}\includegraphics[width=0.47\textwidth]{../images/ErrorBar/ModelDataWithError.png}}
\subfigure[Ration between supplied error bar and the error bar guessed by \SASfit]{\label{fig:ErrorGUI2}\includegraphics[width=0.47\textwidth]{../images/ErrorBar/RatioErrSuppGuess.png}}
\end{center}
