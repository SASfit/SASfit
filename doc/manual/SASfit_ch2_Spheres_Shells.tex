...
This implementation of a spherical shell is parameterised with an inner radius $ R_2$ and outer
...
\end{figure}
This implementation of a spherical shell is parameterised with an outer radius $R$ and an inner
...
\end{figure}
This implementation of a spherical shell is parameterised with an inner radius $R$ and a shell
