...
the sech-squared distribution. The mode, mean and median values are $x_0$.
\vspace{1cm}
\subsection{LogitNormal (Amplitude)} ~\\
...
\centering
\subcaptionbox{\texttt{general trapez (Area)} distrib. \label{fig:generaltrapezArea} }{\includegraphics[width=0.45\textwidth]{../images/peaks/trapez/generaltrapezArea.png}}
\hfill
\subcaptionbox{\texttt{symm general trapez (Area)} distrib. \label{fig:symmgeneraltrapezArea} }{\includegraphics[width=0.5\textwidth]{../images/peaks/trapez/symmgeneraltrapezArea.png}}
...
\subsection{Generalized trapezoidal peak (Ampl)} ~\\

\begin{figure}[htb]
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{\texttt{general trapez (Ampl)} distrib. \label{fig:generaltrapezAmpl} }{\includegraphics[width=0.45\textwidth]{../images/peaks/trapez/generaltrapezAmpl.png}}
\hfill
\subcaptionbox{\texttt{symm general trapez (Ampl)} distrib. \label{fig:symmgeneraltrapezAmpl} }{\includegraphics[width=0.5\textwidth]{../images/peaks/trapez/symmgeneraltrapezAmpl.png}}
\caption{general trapezoidal peak}
\end{figure}
...
This function contains next to the two width parameter $w_1$ and $w_2$ also a smoothing parameter $\sigma$, a location parameter $x_0$ as well as a scaling parameter $A$ defining the area below the curve $y(x)$ and an offset or background parameter $c_0$. The function is define over the whole domain of real numbers.
