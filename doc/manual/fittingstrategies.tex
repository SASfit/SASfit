...
$\nu=N-m$ is called the "number of degree of freedom".
...
would yield a value of $\chi^2$ is equal or greater than the measured
one is given by
\begin{equation}
...
They introduced the $R$ factor \cite{Rfactor,Hamilton1965} as a measure of model quality which is defines as
...
$R$ factor must always be treated with caution, as an indicator of
