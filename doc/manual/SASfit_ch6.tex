...
polarisation, efficientcy of the spin-flipper and in case of an
...
(\texttt{cross-term (rad.~avg.)}) has bee implemented. Finally we
end up with the following possible combinations:
\begin{align}
\left.
  \begin{array}{l}
    \texttt{FF+(Chain,RW)} \\
...
\ref{eq:plugin:I_ijSQ} can be written in terms of the order
