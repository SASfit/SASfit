...
\end{align}
\begin{figure}[htb]
\subfigure[Onsager orientation distribution for $\kappa=3$. ]{\includegraphics[width=0.58\textwidth]{../images/form_factor/cylindrical_obj/pOnsager(3).png}}
\hfill
\subfigure[Onsager orientation distribution for $\kappa=-3$. ]{\includegraphics[width=0.38\textwidth]{../images/form_factor/cylindrical_obj/pOnsager(-3).png}}
