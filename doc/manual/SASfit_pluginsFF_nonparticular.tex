...
exponent with typical valuse around $\frac12$. For $H=\frac12$ the gDAB-model results into the the DAB model describes in section \ref{sect:DAB}. The scattering intensity is implemented as
\begin{align}
