...
\begin{align}
\lim_{Q\rightarrow\infty} I_\mathrm{genGauss}(Q,R,\alpha) \propto e^{-R_g^2Q^2/(6+2\alpha)}Q^{\alpha)}
\end{align}
A decay of $Q^{-4}$  therefore occurs for $\alpha=-1$. 
For certain values of $\alpha$ the form factor can be expressed simple functions. A few examples are
\begin{align}
