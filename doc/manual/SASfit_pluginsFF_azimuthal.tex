...
\centering
\subcaptionbox{Scattering curve $I(q)$ of a long cylinder aligned according to a Maier-Saupe orientation distribution \label{fig:comparisionOfAzimuthalIntModels1} }{\includegraphics[width=0.48\textwidth]{../images/form_factor/azimuthal/I(Q)_MS_Cylinder.png}}
\hfill
\subcaptionbox{Azimuthal intensity distribution $I(\psi)$ of the same model as on the left \label{fig:comparisionOfAzimuthalIntModels2} }{\includegraphics[width=0.48\textwidth]{../images/form_factor/azimuthal/I(PSI)_MS_Cylinder.png}}
