...
\vphantom{.}~\\
\subsection{Kovalenko-Hirata closure (KH)}
~\\
Kovalenko and Hirata \cite{Kovalenko1999} introduced a closure for studying self-consistent description of a metal–water interface and which has been used later on e.g. by \cite{Hus2013} to study core-softened potentials. Their bridge function reads as
