...
\centering
\subcaptionbox{sticky hard sphere potential $u^\text{SHS}(r,\sigma)$ e\label{fig:OZUSHS} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potUSHS.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{SHS}(r,\sigma)$ \label{fig:OZMeyerfSHS} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfSHS.png}}
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{Potential of the Penetrable Sphere Model (PSM) $u^\text{PSM}(r,\sigma,\ldots)$ \label{fig:OZUPSM} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potUPenetrableSphere.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{PSM}(r,\sigma,\ldots)$ \label{fig:OZMeyerfPSM} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfPenetrableSphere.png}}
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{Potential of the Generalises Gaussian Code Model (GGCM-n) $u^\text{GGCM-n}(r,\sigma,\ldots)$ \label{fig:OZUGGCM} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potUGGCM-n.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{GGCM-n}(r,\sigma,\ldots)$ \label{fig:OZMeyerfGGCM} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfGGCM-n.png}}
e
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{Fermi potential $u^\text{Fermi}(r,\sigma,\ldots)$ \label{fig:OZUFermi} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potUFermi.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{Fermi}(r,\sigma,\ldots)$ \label{fig:OZMeyerfFermi} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfFermi.png}}
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{Star potential $u^\text{star1}(r,\sigma,f)$ \label{fig:OZUStar} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potUStarfGT10.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{star1}(r,\sigma,f)$ \label{fig:OZMeyerfStar} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfStarfGT10.png}}
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{Star potential for $u^\text{star2}(r,\sigma,f)$ \label{fig:OZUStarLT10} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potUStarfLT10.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{star2}(r,\sigma,f)$ \label{fig:OZMeyerfStarLT10} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfStarfLT10.png}}
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{Lennard-Jones potential $u^\text{LJ}(r,\sigma,\ldots)$ \label{fig:OZULJ} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potULennardJones.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{LJ}(r,\sigma,\ldots)$ \label{fig:OZMeyerfLJ} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfLennardJones.png}}
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{potential between two large spheres and spherical depleting agents $u^\text{depl}_\text{sph}(r,\sigma,\ldots)$ \label{fig:OZUDeplSph} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potUDepl-Sph-Sph.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{depl}_\text{sph}(r,\sigma,\ldots)$ \label{fig:OZMeyerfDeplSph} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfDepl-Sph-Sph.png}}
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{potential between two large spheres and disclike depleting agents $u^\text{depl}_\text{discs}(r,\sigma,\ldots)$ \label{fig:OZUDeplDisc} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potUDepl-Sph-Discs.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{depl}_\text{discs}(r,\sigma,\ldots)$ \label{fig:OZMeyerfDeplDisc} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfDepl-Sph-Discs.png}}
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{potential between two large spheres and rodlike depleting agents $u^\text{depl}_\text{rods}(r,\sigma,\ldots)$ \label{fig:OZUDeplRod} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potUDepl-Sph-Rods.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{depl}_\text{rods}(r,\sigma,\ldots)$ \label{fig:OZMeyerfDeplRod} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfDepl-Sph-Rods.png}}
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{DLVO potential (Derjaguin and Landau, Verwey and Overbeek) $u^\text{DLVO}(r,\sigma,\ldots)$ \label{fig:OZUDLVO} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potUDLVO_a.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{DLVO}(r,\sigma,\ldots)$ \label{fig:OZMeyerfDLVO} }{\includegraphics[width=0.48\textwidth]{../images/OZsolver/potentials/potfDLVO.png}}
...
\captionsetup[subfigure]{position=b}
\centering
\subcaptionbox{Hard Core Yukawa potential with three linear combinations of Yukawa tails $u^\text{HC3Y}(r,\sigma,\ldots)$ \label{fig:OZUHC3Y} }{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUHC3Yukawa.png}}
\hfill
\subcaptionbox{Mayer-f function of $u^\text{HC3Y}(r,\sigma,\ldots)$ \label{fig:OZMeyerfHC3Y} }{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfHC3Yukawa.png}}
