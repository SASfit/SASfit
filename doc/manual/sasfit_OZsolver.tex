...
\begin{figure}[htb]
\centering
  \subfigure[DLVO potential (Derjaguin and Landau, Verwey and Overbeek) $u^\text{DLVO}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth,height=0.314\textwidth]{../images/OZsolver/potentials/potfDLVO.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{DLVO}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth,height=0.314\textwidth]{../images/OZsolver/potentials/potUDLVO_a.png}}
