...
The easiest algorithm for solving the Ornstein Zernike (OZ) equation \ref{eq:ozh(r)} together with the closure equation \ref{eq:ozclosure} is direct iteration using fast Fourier transformation (see e.g. \cite{Homeier1995}). The solution of the OZ equations can be treated either as a fixed point problem for the unknown function $\gamma(r)$, so that $T^\mathrm{OZ}_f(\gamma)=\gamma$ or as a multidimensional root finding problem $F^\mathrm{OZ}_r(\gamma)=T^\mathrm{OZ}_f(\gamma)-\gamma=0$. In \SASfit the fix point problem $T^\mathrm{OZ}_f(\gamma)=\gamma$ is implemented as:
\begin{enumerate}
...
The following iteration schemes are implemented:
\begin{description}
...
\vphantom{.}~\\
\subsection{Charpentier-Jakse' semiemical extention of the VM Approximation (CJ-VM)}
~\\

A similar semiemical approach has been suggested by Charpentier and Jakse
...
\begin{figure}[htb]
\centering
  \subfigure[Hard Sphere potential $u^\text{HS}(r,\sigma)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUHS.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{HS}(r,\sigma)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfHS.png}}
...
\begin{figure}[htb]
\centering
  \subfigure[Sticky Hard Sphere potential $u^\text{SHS}(r,\sigma)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUSHS.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{SHS}(r,\sigma)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfSHS.png}}
...
\begin{figure}[htb]
\centering
  \subfigure[Soft Sphere Potential $u^\text{SSP}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUSoftSphere.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{SSP}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfSoftSphere.png}}
...
\begin{figure}[htb]
\centering
  \subfigure[Potential of the Penetrable Sphere Model (PSM) $u^\text{PSM}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUPenetrableSphere.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{PSM}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfPenetrableSphere.png}}
...
\begin{figure}[htb]
\centering
  \subfigure[Potential of the Generalises Gaussian Code Model (GGCM-n) $u^\text{GGCM-n}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUGGCM-n.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{GGCM-n}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfGGCM-n.png}}
...
\begin{figure}[htb]
\centering
  \subfigure[Fermi potential $u^\text{Fermi}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUFermi.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{Fermi}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfFermi.png}}
...
\begin{figure}[htb]
\centering
  \subfigure[Star potential $u^\text{star1}(r,\sigma,f)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUStarfGT10.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{star1}(r,\sigma,f)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfStarfGT10.png}}
...
\begin{figure}[htb]
\centering
  \subfigure[Star potential for $u^\text{star2}(r,\sigma,f)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUStarfLT10.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{star2}(r,\sigma,f)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfStarfLT10.png}}
...
\begin{figure}[htb]
\centering
  \subfigure[Lennard-Jones potential $u^\text{LJ}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potULennardJones.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{LJ}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfLennardJones.png}}
...
\begin{figure}[htb]
\centering
  \subfigure[potential between two large spheres and spherical depleting agents $u^\text{depl}_\text{sph}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUDepl-Sph-Sph.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{depl}_\text{sph}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfDepl-Sph-Sph.png}}
...
\begin{subeqnarray}
u^\text{depl}_\text{sph,R}(r) &=&
\begin{cases}
u^\text{depl}_\text{sph}(r) &\mbox{for } r<\sigma \\
0 &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{sph,A}(r) &=&
\begin{cases}
u^\text{depl}_\text{sph}(\sigma) &\mbox{for } r<\sigma \\
u^\text{depl}_\text{sph}(r) &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{sph,ref}(r) &=&
\begin{cases}
u^\text{depl}_\text{sph}(r) &\mbox{for } r<\sigma \\
0 &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{sph,pert}(r) &=&
\begin{cases}
u^\text{depl}_\text{sph}(\sigma) &\mbox{for } r<\sigma \\
u^\text{depl}_\text{sph}(r) &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{sph,SR}(r) &=&
\begin{cases}
u^\text{depl}_\text{sph}(r) &\mbox{for } r<\sigma \\
0 &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{sph,LR}(r) &=&
\begin{cases}
u^\text{depl}_\text{sph}(\sigma) &\mbox{for } r<\sigma \\
u^\text{depl}_\text{sph}(r) &\mbox{for } r>=\sigma
\end{cases}
...
Also a splitting of the potential in repulsive-attractive, reference-perturbation, shortrange-longrange has been implemented as
\begin{subeqnarray}
u^\text{depl}_\text{discs,R}(r) &=&
\begin{cases}
u^\text{depl}_\text{discs}(r) &\mbox{for } r<\sigma \\
0 &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{discs,A}(r) &=&
\begin{cases}
u^\text{depl}_\text{discs}(\sigma) &\mbox{for } r<\sigma \\
u^\text{depl}_\text{discs}(r) &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{discs,ref}(r) &=&
\begin{cases}
u^\text{depl}_\text{discs}(r) &\mbox{for } r<\sigma \\
0 &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{discs,pert}(r) &=&
\begin{cases}
u^\text{depl}_\text{discs}(\sigma) &\mbox{for } r<\sigma \\
u^\text{depl}_\text{discs}(r) &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{discs,SR}(r) &=&
\begin{cases}
u^\text{depl}_\text{discs}(r) &\mbox{for } r<\sigma \\
0 &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{discs,LR}(r) &=&
\begin{cases}
u^\text{depl}_\text{discs}(\sigma) &\mbox{for } r<\sigma \\
u^\text{depl}_\text{discs}(r) &\mbox{for } r>=\sigma
\end{cases}
...
\begin{figure}[htb]
\centering
  \subfigure[potential between two large spheres and disclike depleting agents $u^\text{depl}_\text{discs}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUDepl-Sph-Discs.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{depl}_\text{discs}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfDepl-Sph-Discs.png}}
...
Also a splitting of the potential in repulsive-attractive, reference-perturbation, shortrange-longrange has been implemented as
\begin{subeqnarray}
u^\text{depl}_\text{rods,R}(r) &=&
\begin{cases}
u^\text{depl}_\text{rods}(r) &\mbox{for } r<\sigma \\
0 &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{rods,A}(r) &=&
\begin{cases}
u^\text{depl}_\text{rods}(\sigma) &\mbox{for } r<\sigma \\
u^\text{depl}_\text{rods}(r) &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{rods,ref}(r) &=&
\begin{cases}
u^\text{depl}_\text{rods}(r) &\mbox{for } r<\sigma \\
0 &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{rods,pert}(r) &=&
\begin{cases}
u^\text{depl}_\text{rods}(\sigma) &\mbox{for } r<\sigma \\
u^\text{depl}_\text{rods}(r) &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{rods,SR}(r) &=&
\begin{cases}
u^\text{depl}_\text{rods}(r) &\mbox{for } r<\sigma \\
0 &\mbox{for } r>=\sigma
\end{cases}\\
u^\text{depl}_\text{rods,LR}(r) &=&
\begin{cases}
u^\text{depl}_\text{rods}(\sigma) &\mbox{for } r<\sigma \\
u^\text{depl}_\text{rods}(r) &\mbox{for } r>=\sigma
\end{cases}
...
\begin{figure}[htb]
\centering
  \subfigure[potential between two large spheres and rodlike depleting agents $u^\text{depl}_\text{rods}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUDepl-Sph-Rods.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{depl}_\text{rods}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfDepl-Sph-Rods.png}}
...
Also a splitting of the potential in repulsive-attractive, reference-perturbation, shortrange-longrange has been implemented as
\begin{subeqnarray}
u^\text{DLVO}_\text{ref}(r,\ldots) &=&
\begin{cases}
\infty & \mbox{for } r\leq\sigma \\
0 & \mbox{for } r>\sigma
\end{cases}\\
u^\text{DLVO}_\text{pert}(r,\ldots) &=&
\begin{cases}
0 & \mbox{for } r\leq \sigma \\
u^\text{vdW}(r)+u^\text{el}(r) & \mbox{for } r > sigma
\end{cases}\\
u^\text{DLVO}_\text{SR}(r,\ldots) &=&
\begin{cases}
\infty & \mbox{for } r\leq\sigma \\
u^\text{vdW}(r) & \mbox{for } r>\sigma
\end{cases}\\
u^\text{DLVO}_\text{LR}(r,\ldots)&=&
\begin{cases}
u^\text{el}(\sigma) & \mbox{for } r\leq\sigma \\
u^\text{el}(r) & \mbox{for } r>\sigma
\end{cases}\\
u^\text{DLVO}_\text{R}(r,\ldots) &=&
\begin{cases}
\infty & \mbox{for } r\leq\sigma \\
u^\text{el}(r) & \mbox{for } r>\sigma
\end{cases}\\
u^\text{DLVO}_\text{A}(r,\ldots) &=&
\begin{cases}
0 & \mbox{for } r\leq\sigma \\
u^\text{vdW}(r) & \mbox{for } r>\sigma
\end{cases}
...
\begin{figure}[htb]
\centering
  \subfigure[DLVO potential (Derjaguin and Landau, Verwey and Overbeek) $u^\text{DLVO}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUDLVO_a.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{DLVO}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfDLVO.png}}
...
Also a splitting of the potential in repulsive-attractive, reference-perturbation, shortrange-longrange has been implemented as
\begin{subeqnarray}
u^\text{HC3Y}_\text{ref}(r,\ldots) &=&
\begin{cases}
\infty & \mbox{for } r<\sigma \\
0 & \mbox{for } r\geq\sigma
\end{cases}\\
u^\text{HC3Y}_\text{pert}(r,\ldots) &=&
\begin{cases}
u^\text{HC3Y}_\text{ref}(\sigma,\ldots) & \mbox{for } r<\sigma \\
u^\text{HC3Y}_\text{ref}(r,\ldots) & \mbox{for } r\geq\sigma
\end{cases}\\
u^\text{HC3Y}_\text{SR}(r,\ldots) &=& u^\text{HC3Y}_\text{ref}(r,\ldots) \\
u^\text{HC3Y}_\text{LR}(r,\ldots)&=& u^\text{HC3Y}_\text{pert}(r,\ldots) \\
u^\text{HC3Y}_\text{R}(r,\ldots) &=&
\begin{cases}
\infty & \mbox{for } r<\sigma \\
k_\text{B} T
\displaystyle \sum_{\forall K_i>0} K_i\frac{\exp\left(-\lambda_i\left(\frac{r}{\sigma}-1\right)\right)}{r/\sigma} & \mbox{for } r\geq\sigma
\end{cases}\\
u^\text{HC3Y}_\text{A}(r,\ldots) &=&
\begin{cases}
k_\text{B} T
...
\begin{figure}[htb]
\centering
  \subfigure[Hard Core Yukawa potential with three linear combinations of Yukawa tails $u^\text{HC3Y}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potUHC3Yukawa.png}}
  \quad
  \subfigure[Mayer-f function of $u^\text{HC3Y}(r,\sigma,\ldots)$]{\includegraphics[width=0.45\textwidth]{../images/OZsolver/potentials/potfHC3Yukawa.png}}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=0.708\textwidth]{../images/OZsolver/startOZsolver.png}
\end{center}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=0.913\textwidth]{../images/OZsolver/mainGUIozSolver.png}
\end{center}
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=0.708\textwidth]{../images/OZsolver/OZsolverResults4fitting.png}
\end{center}
