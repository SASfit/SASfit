...
\centering
\subcaptionbox{The influence of irregular particle shapes on
...
for $\nu$ = 1, 0.1, and 1.3. \label{fig:formfactor:interferenzen1} }{\includegraphics[width=0.48\textwidth]{FORMINTE.png}}
\hfill
\subcaptionbox{Influence of a particle size distribution
 ${\rm LogNorm}(R) = \exp\left(-(\ln\mu-\ln R)^2 / (2 \sigma^2)\right)$ of
 the widths  $\sigma$ = 0.1, 0.2, 0.3, 0.4 for $\mu=5$ nm on
$\vert\overline{F(Q)}\vert^2 / \overline{\abs{F(Q)}^2}$. \label{fig:formfactor:interferenzen2} }{\includegraphics[width=0.48\textwidth]{SIZEINTE.png}}
