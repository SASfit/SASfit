...
right]{
\includegraphics[width=0.48\textwidth]{../images/form_factor/magnetic/IQ4spinmisalignment.png}}
\hfill \subfigure[correlation functions for the scattering curves to
the left]{
\includegraphics[width=0.48\textwidth]{../images/form_factor/magnetic/correlation4spinmisalignment.png}}
\end{center}
