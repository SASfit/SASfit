...
\end{split}  
\end{align}
with $p=\left(4\sqrt{3}\pi-12\right)/\pi^2$ and being $\Theta()$ the Heaviside function. The parameter $a$ are the roots of a non-linear equation, which has been solved numerically and then approximated via a polynomial fitting by
\begin{align}
a &= 0.3699\eta^4
      -1.2511\eta^3
      +2.0199\eta^2
