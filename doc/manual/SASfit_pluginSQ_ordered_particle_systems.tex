...
\begin{subequations}
\begin{align}
\mathbf{a}\cdot\mathbf{a}^\star=1 \quad \mathbf{a}\cdot\mathbf{b}^\star=0 \quad \mathbf{a}\cdot\mathbf{c}^\star=0 \\
\mathbf{b}\cdot\mathbf{a}^\star=0 \quad \mathbf{b}\cdot\mathbf{b}^\star=1 \quad \mathbf{b}\cdot\mathbf{c}^\star=0 \\
\mathbf{c}\cdot\mathbf{a}^\star=0 \quad \mathbf{c}\cdot\mathbf{b}^\star=0 \quad \mathbf{c}\cdot\mathbf{c}^\star=1 \\
\end{align}
\end{subequations}
