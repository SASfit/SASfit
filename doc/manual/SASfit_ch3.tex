...
~\\
\cite{Mladek2005,Louis2000}.
\begin{align}
U^\text{GGCM-n}(r)&=
k_\text{B} T \epsilon \exp\left(-\alpha\left(r/sigma\right)^n\right)
\end{align}
...
~\\
See \cite{Oversteegen2004,Lekkerkerker2011}
...
electric charge $e=1.602176565(35)\times 10^{-19}$coulombs\footnote{The Gaussian units uses
