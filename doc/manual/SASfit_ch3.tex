...
If the difference between the new and old one has significantly
change go back to the first step by using the new $\gamma(r)$ as a
...
\end{align}
For calculating the Fourier transformation the library FFTW for fast fourier transformation \cite{FFTW05,FFTW97} has been used.
The library supplies a discrete sin transformation (type-I DST) named \verb"FFTW_RODFT00" which doing the transformation
\begin{align}
